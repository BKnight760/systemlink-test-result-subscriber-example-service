# -*- coding: utf-8 -*-
"""
Implementation of 'AmqpConsumerConnection' class
"""
...
class AmqpConsumerConnection(AmqpConnection):  # pylint: disable=too-many-instance-attributes
    """
    AMQP Consumer Connection.

    A connection that is used only for consuming (reading)
    ...
    def __init__(self,  # pylint: disable=useless-super-delegation,too-many-arguments
        ...
        """
        super(AmqpConsumerConnection, self).__init__(
            amqp_connection_manager,
            user_name,
            password,
            host_name,
